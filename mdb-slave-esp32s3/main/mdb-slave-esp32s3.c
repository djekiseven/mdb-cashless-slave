...
#define pin_mdb_rx  	GPIO_NUM_16  // Pin to receive data from MDB
#define pin_mdb_tx  	GPIO_NUM_17  // Pin to transmit data to MDB
#define pin_mdb_led 	GPIO_NUM_2 // LED to indicate MDB state
